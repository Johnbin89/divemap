        ...
        <div className='bg-white rounded-lg shadow-lg p-8'>
          <div className='prose prose-blue dark:prose-invert max-w-none'>
            ...
            <section className='not-prose mb-8'>
              ...
              <div className='bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg'>
                ...
                <p className='text-blue-800 dark:text-blue-200 mb-4'>
                  ...
                  when you visit our website. Personal information is any data with which you could
            ...
            <section>
              ...
              <p>
                Divemap provides an AI-powered assistant to help you with diving-related queries.
              ...
              <ul>
                ...
                <li>
                  ...
                  Language Models (LLMs) provided by third parties, primarily{' '}
                  <strong>OpenAI</strong> and <strong>Deepseek</strong>. We do not share your
                  username or identity with these providers, but the content of your prompt is sent
                  for processing.
                </li>
              </ul>
            ...
            <section>
              ...
              <div>
                ...
                <p>
                  ...
                  certain profile information from the provider, such as your name, email address,
                  and profile picture URL. We use this data only to create and manage your Divemap
            ...
            <section>
              ...
              <div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg mb-6 not-prose'>
                ...
                <p className='text-green-800 dark:text-green-200'>
                  ...
                  information. We are committed to keeping your personal information private and
                  will not sell, trade, or otherwise transfer your personal data to third parties
            ...
            <section>
              ...
              <p>
                Under applicable data protection laws, you have several rights regarding your
            ...
            <section>
              ...
              <div>
                ...
                <p>
                  ...
                  basic functions like page navigation, access to secure areas, and user
                  authentication.
                </p>
              </div>
              <div>
            ...
            <section>
              ...
              <p>
                We use Cloudflare Turnstile on our website to protect against automated bots and
                spam. This service is provided by Cloudflare, Inc.
              </p>
              <p>
              ...
              <p>
                The data collected during this analysis is processed by Cloudflare in accordance
                with their privacy policy. We do not have access to the specific data collected by
                Turnstile.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Our website uses Leaflet, an open-source mapping library, to provide interactive
                maps and location services. Leaflet is developed and maintained by the Leaflet
                community.
              </p>
              ...
              <p>
                ...
                location data with third-party mapping services unless you explicitly choose to do
                so.
              </p>
            </section>
            ...
            <section>
              ...
              <div className='bg-green-50 dark:bg-green-900/20 p-6 rounded-lg not-prose'>
                <p className='text-green-800 dark:text-green-200'>
                  <strong>Important:</strong> Divemap does not display any advertising on our
                  website. We do not use your personal information for marketing purposes, and we do
                  not share your data with advertisers or marketing companies.
                </p>
              </div>
              <p>
